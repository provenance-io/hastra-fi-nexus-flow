...
The Hastra repository is built on the work of many open source projects.
...
Thank you for considering making contributions to Hastra!

Contributing to this repo can mean many things such as participated in
discussion or proposing code changes. To ensure a smooth workflow for all
contributors, the general procedure for contributing has been established:

1. Either [open](https://github.com/provenance-io/hastra-fi-nexus-flow/issues/new/choose) or
   [find](https://github.com/provenance-io/hastra-fi-nexus-flow/issues) an issue you'd like to help with
...
- Looking for a good place to start contributing? How about checking out some
  [good first issues](https://github.com/provenance-io/hastra-fi-nexus-flow/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
...
If you open a PR on Hastra, please update the relevant documentation in /docs.
...
- On the `release` branch, prepare a new version section in the `CHANGELOG.md`
  - At the top of latest changes add `## [vx.x.x](https://github.com/provenance-io/hastra-fi-nexus-flow/releases/tag/vx.x.x) - YYYY-MM-DD`
