...
export const WalletIconComponent = ({ walletType, className }: { walletType: string | null; className?: string }) => {
  ...
  const FallbackIcon = walletType ? fallbackIcons[walletType] || fallbackIcons.default : fallbackIcons.default;
