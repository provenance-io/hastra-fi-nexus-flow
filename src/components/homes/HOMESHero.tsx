...
const HOMESHero = () => {
  return (
    <section className="relative py-20 md:py-32 overflow-hidden">
      ...
      <div
        className="absolute top-32 right-16 opacity-20 animate-float"
      ...
      <div className="container relative text-center animate-fade-in">
        ...
        <p className="mt-6 max-w-4xl mx-auto text-xl md:text-2xl text-muted-foreground leading-relaxed">
          Access competitive yields through Real World Asset pools on Solana.
          Earn attractive returns with both yield tokens and enhanced HASH token
          rewards.
        </p>

        <div className="my-8">
          <p className="text-lg text-muted-foreground">Target Yield</p>
          <p className="text-6xl md:text-7xl font-bold text-gradient">7.5%</p>
        ...
        <div className="mt-8 flex flex-col sm:flex-row justify-center gap-4">
          <Button className="min-w-[200px] group" variant="secondary" size="lg">
            Learn More
