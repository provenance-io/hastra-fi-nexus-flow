...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-border/50 card-gradient backdrop-blur-md shadow-sm shadow-header-glow/5" style={{ background: 'rgba(40, 40, 40, 0.7)' }}>
