          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              <div className="flex items-center bg-muted/30 rounded-md p-1 gap-1 min-w-0">
                <Button variant={denomination === 'usd' ? 'default' : 'ghost'} size="sm" onClick={() => setDenomination('usd')} className={`h-7 text-xs px-2 min-w-[50px] ${denomination === 'usd' ? 'btn-hastra' : 'text-muted-foreground hover:text-auburn-primary'}`}>
