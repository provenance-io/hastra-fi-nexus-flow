...
const TokenLineItem = ({
  ...
  return (
    <div className="bg-background/30 rounded-2xl border border-border/20 hover:border-amber-glow/15 transition-all duration-300 hover:shadow-[0_0_8px_rgba(229,218,194,0.1),0_0_15px_rgba(229,218,194,0.05)] mw-full mx-auto px-2 lg:px-4">
          ...
          {onClaim &&
            (console.log(`${token} has onClaim prop`, !!onClaim), true) && (
              <Button
                ...
                size="sm"
                className="px-4 py-2 mr-4 text-xs font-medium rounded-lg disabled:opacity-50 whitespace-nowrap"
                variant="secondary"
              >
                {isClaiming ? (
        ...
        {onClaim && (
          ...
          >
            {isClaiming ? (
              ...
              <span>
                Claim {token} - ${unclaimedInterestUSD.toFixed(2)}
              </span>
            )}
          </Button>
        )}
