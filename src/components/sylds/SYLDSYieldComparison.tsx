            ...
            <div className="grid gap-6 md:grid-cols-3">
              {[
                ...
                },
                {
                  ...
                  description: "Earn leveraged returns while maintaining exposure to real asset yields",
                  step: "3"
                }
              ].map((step, index) => (
                <Card key={step.step} className="p-6 bg-background/30 backdrop-blur-sm border-border/40 relative">
          ...
          <div className="relative z-10">
            ...
            <div className="grid gap-6 md:grid-cols-3">
              {[
                ...
                <Card key={strategy.title} className="p-6 bg-background/30 backdrop-blur-sm border-border/40 hover:bg-background/50 transition-all duration-300">
                  <div className="text-center">
                    <h4 className="font-bold text-foreground mb-2">
                      {strategy.title}
                    </h4>
                    <div className={`text-3xl font-bold mb-3 ${strategy.color}`}>
                      {strategy.apy}
                    </div>
          ...
          <div className="relative z-10">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="space-y-4">
                <h4 className="font-semibold text-foreground">Leverage Risks:</h4>
            ...
            <div className="mt-8 p-4 bg-background/20 rounded-xl border border-border/20">
              <p className="text-xs text-muted-foreground leading-relaxed">
                <strong>Disclaimer:</strong> Leveraged strategies involve significant risk and may not be suitable for all investors. 
                Past performance does not guarantee future results. Please understand all risks before participating in leveraged strategies.
              </p>
            </div>
