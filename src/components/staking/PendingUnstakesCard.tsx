...
const PendingUnstakesCard: React.FC = () => {
    ...
    if (!pendingUnstake || !pendingUnstake.data) {
        return (
            <Card
                className="bg-background/30 rounded-xl border border-border/20 hover:border-amber-glow/15 transition-all duration-300 hover:shadow-[0_0_8px_rgba(229,218,194,0.1),0_0_15px_rgba(229,218,194,0.05)] p-6">
                <div className="text-center space-y-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                            Your unstaking requests will appear here during the
                            cooldown period
                        </p>
                    </div>
                </div>
    ...
    const progress = getUnstakeProgress(pendingUnstake.data.initiatedAt, pendingUnstake.data.availableAt);
            ...
            <div className="space-y-6">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div className="text-right space-y-1">
                            <div
                                ...
                                {formatStakingAmount(pendingUnstake.data.amount)} sYLDS
                            </div>
                    ...
                    <div
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-2">
                                <CheckCircle
                                    className="h-4 w-4 text-[hsl(48_100%_67%)]"/>
                                <div>
                            ...
                            >
                                {isTransacting ? (
                                    <>
                                        <div
                                            className="animate-spin rounded-full h-3 w-3 border-2 border-white border-t-transparent mr-2"/>
                                        Unstaking...
                                    </>
                                ) : (
                                    <>
                                        ...
                                        <ArrowRight
                                            className="ml-2 h-3 w-3 text-[hsl(48_100%_67%)]"/>
                                    </>
                                )}
                            </Button>
                        </div>
                ...
                {showDetails && (
                    <div className="space-y-3">
                        <div
                            className="flex items-center justify-between text-sm text-muted-foreground border-b border-border/30 pb-2 mb-4">
                            <span>Individual Unstake</span>
                        </div>
                        <div
                            className="relative border-l-2 border-auburn-primary/30 pl-4 ml-2 p-4 bg-background/30 rounded-xl border hover:border-amber-glow/15 transition-all duration-300 hover:shadow-[0_0_8px_rgba(229,218,194,0.1),0_0_15px_rgba(229,218,194,0.05)]"
                        >
                            <div
                                ...
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-muted-foreground">
                                            Initiated {formatTimestamp(pendingUnstake.data.initiatedAt)}
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="mt-3 flex justify-end">
                                    ...
                                    >
                                        {isTransacting ? (
                                            <>
                                                <div
                                                    className="animate-spin rounded-full h-3 w-3 border-2 border-white border-t-transparent mr-1"/>
                                                Unstaking...
                                            </>
                                        ) : (
                                            <>
                                                Unstake to wYLDS
                                                <ArrowRight
                                                    className="ml-1 h-2.5 w-2.5 text-[hsl(48_100%_67%)]"/>
                                            </>
                                        )}
                                    </Button>
                                </div>
