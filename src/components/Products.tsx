    ...
    >
      ...
      <div className="container relative">
        <div className="text-center space-y-4 mb-12 -mt-8">
          ...
          >
            Grow your wealth,{" "}
            <span className="text-gradient">not your workload.</span>
          </h2>
          <p
        ...
        <div className="max-w-6xl mx-auto space-y-8">
          ...
          <div className="card-gradient rounded-3xl p-8 md:p-12 space-y-8 animate-fade-in-up">
            ...
            <div className="space-y-8">
              ...
              <p
                ...
                style={{ color: "hsl(var(--hastra-teal))" }}
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {yieldStats.map((stat, index) => {
                const IconComponent =
                  statIcons[stat.label as keyof typeof statIcons] || TrendingUp;
                return (
                  <div
                    key={stat.label}
          ...
          >
            ...
            <div className="space-y-8">
              <p className="text-lg md:text-xl text-foreground/90 leading-relaxed">
                {products(apy).sylds.description}
              </p>
            ...
            {/* Stats grid */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {products(apy).sylds.stats.map((stat, index) => {
                const IconComponent =
