...
export const Hero = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="absolute top-[25%] left-[5%] lg:left-[10%] xl:left-[15%] 2xl:right-[30%] z-10">
          ...
          <p className="pt-[42px] text-[22px] leading-[118%] md:w-1/2 lg:w-full">
        ...
        <img
          src={heroImage}
          alt="About Hero"
          className="absolute right-0 overflow-hidden max-h-[896px]"
        />
        <div className="absolute right-0 overflow-hidden min-h-[896px] bg-gradient-to-tr from-black to-transparent to-[90%] w-screen" />
      </div>
