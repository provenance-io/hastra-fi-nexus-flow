    ...
    <section className="py-20 relative">
      <div className="container relative">
        <div className="max-w-6xl mx-auto">
          <h2
            className="text-xl md:text-2xl text-foreground/90 max-w-4xl mx-auto leading-relaxed mb-16 text-center"
            style={{
              textShadow:
          ...
          <div className="grid lg:grid-cols-2 gap-12 mb-16">
            <div className="card-gradient rounded-3xl p-8 card-bottom-static border border-transparent">
              <h3 className="text-2xl font-bold mb-6 text-hastra-teal">
                Primary Logo
              </h3>
              ...
              <p className="text-foreground/90 leading-relaxed">
                The Hastra logo represents the convergence of traditional
                finance and blockchain innovation. Always maintain proper
                proportions and ensure adequate contrast.
              </p>
            </div>

            <div className="card-gradient rounded-3xl p-8 card-bottom-static border border-transparent">
              <h3 className="text-2xl font-bold mb-6 text-auburn-primary">
                Usage Guidelines
              </h3>
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-3">
                  <CheckCircle className="w-5 h-5 text-mint-green mt-0.5 flex-shrink-0" />
                  <p className="text-foreground/90">
                    Use high-resolution SVG format for scalability
                  </p>
                </div>
                <div className="flex items-start space-x-3">
                  <CheckCircle className="w-5 h-5 text-mint-green mt-0.5 flex-shrink-0" />
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <Card className="card-gradient border-red-400/20">
              <CardContent className="p-8">
                ...
                <div className="grid grid-cols-1 gap-4">
                  <div className="bg-white/5 rounded-lg p-4 text-center">
                    <div className="ml-24 md:ml-20 transform scale-x-150">
                      <HastraLogo className="h-12 mx-auto mb-2" />
                    </div>
