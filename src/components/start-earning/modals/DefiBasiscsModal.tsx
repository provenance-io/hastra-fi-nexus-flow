...
const DefiBasiscsModal = memo<LearningModalProps>(({ isOpen, onClose }) => {
  const lessons: LessonData[] = [
    ...
    },
    {
      ...
      description: "Essential security practices and privacy considerations for safe DeFi participation.",
      duration: "18 min",
      level: "Beginner" as const,
      topics: [
    ...
    },
    {
      ...
      description: "Comprehensive reference guide covering all essential DeFi best practices and safety guidelines.",
      duration: "15 min",
      level: "Beginner" as const,
      topics: [
        ...
        <div className="p-8 space-y-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Build a solid foundation in DeFi with our essential basics track. You'll learn what DeFi 
              actually is, how to stay secure, and get a comprehensive best practices reference guide. 
              Perfect for complete beginners who want to understand DeFi safely before diving deeper.
            </p>
          </div>
            ...
            <Card className="border-header-glow/20">
              ...
              <CardContent>
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li className="flex items-start gap-2">
                    <div className="w-1 h-1 rounded-full bg-header-glow mt-2 flex-shrink-0" />
                    <span>Platform-specific guides for wYLDS and swYLDS</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-1 h-1 rounded-full bg-header-glow mt-2 flex-shrink-0" />
