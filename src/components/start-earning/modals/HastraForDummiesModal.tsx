    ...
    <CardHeader className="pb-3">
      <div className="flex items-start justify-between mb-2">
        <div className="flex items-center gap-2">
          <Badge variant={tokenType === 'YIELD' ? 'default' : 'secondary'}>
            {tokenType}
          </Badge>
...
/**
 * Track 3: Hastra for Dummies Modal - Platform-specific content for YIELD and HASH
 */
const HastraForDummiesModal = ({ isOpen, onClose }: HastraForDummiesModalProps) => {
  const modules = [
    {
      title: "What is YIELD?",
      description: "Complete introduction to the YIELD token, its purpose, and core functionality within the Hastra ecosystem.",
      duration: "10 min",
      status: "Available" as const,
      tokenType: "YIELD" as const,
      topics: [
        "YIELD token fundamentals",
    ...
    {
      title: "How to Get YIELD",
      description: "Step-by-step guide to acquiring YIELD tokens through various methods and platforms.",
      duration: "12 min",
      status: "Available" as const,
      tokenType: "YIELD" as const,
      topics: [
        "Where to buy YIELD tokens",
        "Wallet setup for YIELD",
        "Transaction walkthrough",
        "Best practices for acquisition"
      ]
    },
    {
      title: "Using YIELD on Hastra",
      description: "Comprehensive guide to utilizing YIELD tokens effectively within the Hastra platform.",
      duration: "15 min",
      status: "Available" as const,
      tokenType: "YIELD" as const,
      topics: [
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground mt-1">
                  Master YIELD and HASH tokens in the Provenance ecosystem
                </p>
              </div>
            </div>
          </DialogHeader>
        ...
        <div className="p-8 space-y-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              everything from understanding YIELD and HASH tokens to actually using them effectively. 
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {modules.filter(module => module.tokenType === 'YIELD').map((module, index) => (
