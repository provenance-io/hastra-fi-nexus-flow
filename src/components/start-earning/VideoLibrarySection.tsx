...
const videos = [
  ...
  },
  {
    ...
    description: "Deep dive into providing liquidity on Raydium and earning trading fees",
    duration: "18:20",
      ...
      <div className="container">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Comprehensive video tutorials covering everything from DeFi basics to advanced yield strategies
          </p>
        </div>
              ...
              <div className="flex flex-col lg:flex-row gap-8">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-3">
                    <Badge className={difficultyColors[featuredVideo.difficulty as keyof typeof difficultyColors]}>
        ...
        <div className="max-w-6xl mx-auto mb-8">
          <div className="flex flex-col md:flex-row gap-4 mb-6">
            ...
            <Button variant="outline" className="border-header-glow/30 text-header-glow hover:bg-header-glow/10">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredVideos.map((video) => (
              <Card key={video.id} className="glass-effect border-border/50 hover:border-header-glow/30 transition-all duration-300 group cursor-pointer">
