    ...
    <section className="relative py-20 md:py-32 overflow-hidden">
      ...
      <div className="container relative">
        ...
        <div className="text-center mb-12 animate-fade-in">
          ...
          <p
            className="text-xl md:text-2xl text-platinum/80 max-w-4xl mx-auto leading-relaxed mb-16"
            style={{
              textShadow:
        ...
        <div className="text-center">
          <p
            className="text-lg text-platinum/70 mb-8"
            style={{
              textShadow: "0 0 10px rgba(255, 255, 255, 0.2)",
            }}
          >
            {isConnected
              ? "Wallet connected! View your dashboard below."
              : "Ready to start earning with premium DeFi products?"}
          </p>
          <Button
            size="lg"
            variant="secondary"
