...
const enhancedQuickStarters = [
  {
    ...
    content: {
      intro:
        "Security is the foundation of successful DeFi participation. This comprehensive guide covers everything you need to protect your assets and navigate DeFi safely, from wallet basics to advanced security practices.",
      sections: [
        {
  ...
  },
  {
    ...
    description:
      "Step-by-step walkthrough from setup to earning your first yield",
    ...
    content: {
      intro:
        "Transform your first $100 into a learning experience that sets the foundation for larger DeFi investments. This guide provides a complete roadmap from choosing platforms to managing your positions.",
      sections: [
        {
        ...
        },
        {
          ...
          content: [
            ...
            "Choose between PRIME (stable) or wHASH (growth)",
  ...
  },
  {
    ...
    description:
      "Deep dive into understanding returns, risks, and realistic expectations",
    ...
    prerequisites: [
      ...
      "DeFi platform familiarity",
    ],
    outcomes: [
      "APY calculation skills",
      "Risk assessment ability",
      "Realistic return expectations",
    ],
    content: {
      intro:
        "Understanding yield calculations is crucial for making informed DeFi decisions. Learn to calculate real returns, assess risks, and set realistic expectations for your investments.",
      sections: [
        {
...
const comprehensiveGuides = [
  {
    ...
    description:
      "Master cross-chain bridging with detailed walkthrough and troubleshooting",
    ...
    detailedSections: [
      {
        ...
        duration: "5 min",
        content:
          "Learn how Figure Markets bridge works, security mechanisms, and token economics",
      },
      {
        title: "Wallet Setup and Connection",
        duration: "7 min",
        content:
          "Step-by-step wallet configuration for both Provenance and Solana networks",
      },
      {
        title: "Bridge Interface Navigation",
        duration: "6 min",
        content:
          "Complete walkthrough of Figure Markets interface and features",
      },
      {
        title: "Transaction Execution and Monitoring",
        duration: "8 min",
        content:
          "Executing the bridge transaction and tracking progress across networks",
      },
      {
  ...
  },
  {
    ...
    description:
      "Professional-grade liquidity provision techniques and optimization",
    difficulty: "Advanced",
    ...
    detailedSections: [
      {
        ...
        duration: "6 min",
        content:
          "Understanding concentrated liquidity mechanics and capital efficiency",
      },
      {
        title: "Range Selection Strategies",
        duration: "8 min",
        content:
          "Optimal range setting for different market conditions and tokens",
      },
      {
  ...
  },
  {
    ...
    description:
      "Complete guide to automated lending strategies and risk management",
    difficulty: "Advanced",
    ...
    detailedSections: [
      {
        ...
        duration: "5 min",
        content:
          "Understanding Kamino's automated strategy engine and optimization algorithms",
      },
      {
        title: "Strategy Selection Framework",
        duration: "6 min",
        content:
          "Choosing optimal strategies based on risk tolerance and market conditions",
      },
      {
        title: "Collateral Management",
        duration: "7 min",
        content:
          "Advanced collateral strategies and liquidation risk management",
      },
      {
...
const enhancedTips = [
  {
    ...
    icon: Shield,
    details:
      "Professional DeFi investors rarely risk more than 10% on experimental strategies. This allocation ensures you can learn and grow without catastrophic losses.",
    actionItems: [
  ...
  },
  {
    ...
    icon: BarChart3,
    details:
      "Diversification is your primary defense against protocol failures, smart contract bugs, and market volatility in DeFi.",
    actionItems: [
  ...
  },
  {
    ...
    icon: CheckCircle,
    details:
      "Most DeFi losses come from user error or malicious contracts. A systematic verification process eliminates 90% of these risks.",
    actionItems: [
  ...
  },
  {
    ...
    icon: RefreshCw,
    details:
      "Gas fees can eat significant returns on small positions. Optimize compounding frequency to maximize net yields.",
    actionItems: [
  ...
  },
  {
    ...
    icon: TrendingUp,
    details:
      "Unsustainable yields often collapse quickly. Understanding yield sources helps predict longevity and adjust strategies accordingly.",
    actionItems: [
  ...
  },
  {
    ...
    icon: DollarSign,
    details:
      "Tax-aware DeFi strategies can significantly improve after-tax returns through proper timing and structure.",
    actionItems: [
...
const EnhancedGuidesSection = () => {
  ...
  const [selectedGuide, setSelectedGuide] = useState<
    (typeof enhancedQuickStarters)[0] | null
  >(null);
  const [selectedComprehensive, setSelectedComprehensive] = useState<
    (typeof comprehensiveGuides)[0] | null
  >(null);
      ...
      <div className="container">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground max-w-4xl mx-auto leading-relaxed mb-8">
            Comprehensive guides designed by DeFi professionals. From security
                  ...
                  >
                    ...
                    <CardContent>
                      <div className="space-y-6">
                        ...
                        >
                          {guide.detailedSections &&
                            guide.detailedSections.map((section, i) => (
                              <div
                                key={i}
                              ...
                              >
                                ...
                                <div className="flex-1">
                                  ...
                                  <div className="text-xs text-header-glow mt-1">
                                    {section.duration}
                                  </div>
                                </div>
                              </div>
                        ...
                        {guide.tips && (
                          <div className="space-y-2">
                            <h4 className="font-medium text-sm text-header-glow">
                              Pro Tips:
                            </h4>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                              {guide.tips.map((tip, i) => (
                                <div
                                  key={i}
                                  className="text-xs text-muted-foreground bg-muted/10 p-2 rounded border border-border/20"
                                >
                                  💡 {tip}
                                </div>
                              ))}
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    {selectedGuide.content.practicalSteps.map((step, i) => (
                      <div
                        key={i}
                        className="flex items-start gap-3 p-4 rounded-lg bg-header-glow/10 border border-header-glow/30"
                      >
            ...
            <>
              <DialogHeader className="space-y-4">
                ...
                <div className="flex items-center gap-4 text-sm text-muted-foreground">
                  <Badge
                    className={
                      difficultyColors[
                        selectedComprehensive.difficulty as keyof typeof difficultyColors
                      ]
                    }
                  >
              ...
              <div className="space-y-6 mt-6">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <h4 className="font-semibold mb-3 text-header-glow">
                      Prerequisites
                    </h4>
                    <div className="space-y-2">
                ...
                {/* Detailed Sections */}
                <div className="space-y-4">
                  <h4 className="font-semibold text-header-glow">
                    Guide Sections
                  </h4>
