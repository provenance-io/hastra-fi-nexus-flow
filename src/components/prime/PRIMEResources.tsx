...
const resources = [
  {
    ...
    description:
      "Visit the official YLDS website to understand the underlying technology and ecosystem.",
    href: "https://ylds.com",
    icon: ExternalLink,
  },
  {
  ...
  return (
    <section className="py-20 border-t border-border/40">
      <div className="max-w-5xl mx-auto px-4">
        <h2
          className="max-w-3xl mx-auto text-lg md:text-xl lg:text-2xl text-platinum/80 leading-relaxed text-center mb-12"
          style={{
            textShadow:
