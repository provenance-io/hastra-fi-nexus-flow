      ...
      <div className="relative z-10 max-w-5xl mx-auto">
        ...
        <div className="card-gradient rounded-3xl p-8 md:p-12 border border-transparent mb-16 relative">
          <div className="relative z-10">
                    ...
                    <div className="absolute inset-0 w-full h-full backface-hidden">
                      <div className="w-full h-full card-gradient rounded-2xl p-6 text-center space-y-3 hover:bg-background/60 transition-all duration-300">
                        <div className="h-full flex flex-col justify-center">
                          <div className="w-20 h-20 bg-background/40 border border-border/20 rounded-2xl mx-auto mb-6 flex items-center justify-center shadow-lg">
                            <feature.icon className="h-10 w-10 text-header-glow" style={{
            ...
            <p className="text-sm md:text-lg lg:text-xl text-foreground/90 max-w-4xl mx-auto leading-relaxed px-6">
