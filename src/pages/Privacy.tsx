            ...
            <div className="max-w-4xl mx-auto prose prose-invert prose-lg">
              ...
              <div className="card-gradient rounded-3xl p-8 md:p-12 card-bottom-static border border-transparent">
                <div className="space-y-8 text-foreground/90 leading-relaxed">
                  ...
                  <section>
                    <h2 className="text-2xl font-bold text-foreground mb-4">High Level Summary</h2>
                    <ul className="list-disc pl-6 space-y-2">
                      <li>Hastra Technologies Inc.,  is an incorporated company based in Panama that operates the Site among other products and services. Hastra Technologies Inc., complies with applicable laws and regulations.</li>
                      <li>Hastra Technologies Inc., does not collect and store personal data, such as first name, last name, street address, date of birth, email address, or IP address, in connection with your use of the Services.</li>
                      <li>Hastra Technologies Inc.,  collects non-identifiable data, such as public on-chain data, and limited off-chain data like device type, browser version, etc. This is to help drive production vision, not track users.</li>
                      <li>If you specifically sign up to receive emails from us, we will store your email address to allow us to send you those emails. You can unsubscribe at any time. We will not attempt to link your email address to your wallet address, IP address, or other personal data.</li>
                      <li>Hastra Technologies Inc., continues to explore methods to further protect consumers' privacy, such as opt-out prompts, migrating to privacy-centric tooling and deploying proxies to anonymize network traffic.</li>
                  ...
                  <section>
                    ...
                    <ul className="list-disc pl-6 space-y-2">
                      <li>Blocking cookies in your browser by following the instructions in your browser settings. For more information about cookies, including how to see the cookies on your device, manage them, and delete them, visit www.allaboutcookies.org.</li>
                      <li>Blocking or limiting the use of your advertising ID on your mobile device through the device settings.</li>
                  ...
                  <section>
                    <h2 className="text-2xl font-bold text-foreground mb-4">Third-Party Links and Sites</h2>
                    <p>
                  ...
                  <section>
                    <h2 className="text-2xl font-bold text-foreground mb-4">Disclosures for European Union Data Subjects</h2>
                    <p>
                  ...
                  <section>
                    ...
                    <p>
                      If you have any questions about this Policy or how we collect, use, or share your information, please contact us at privacy@hastra.io
                    </p>
                  </section>
                </div>
              </div>
