...
const TestDebug = () => {
  ...
  const shouldShowBanner =
    isLovablePreview && !getProductionFeatureState("testPagesEnabled");
              ...
              <CardHeader>
                ...
                {isLovablePreview && (
                  <p className="text-sm text-muted-foreground">
                    Control which pages are visible in test/production
                    environments
                  </p>
                )}
              </CardHeader>
                ...
                <Table>
                  ...
                  <TableBody>
                    {Object.entries(pageRoutes).map(
                      ([featureKey, { path, name }]) => {
                        const productionState = getProductionFeatureState(
                          featureKey as keyof FeatureFlags
                        );
                        ...
                        return (
                          <TableRow key={featureKey}>
                            ...
                            <TableCell className="text-center">
                              <Badge
                                variant={
                                  productionState ? "default" : "destructive"
                                }
                                className="text-xs"
                              >
                ...
                {isLovablePreview && (
                  <div className="mt-4 p-3 bg-blue-50 dark:bg-blue-950/20 rounded border border-blue-200 dark:border-blue-800">
                    ...
                    <p className="text-blue-600 dark:text-blue-400 text-sm mt-1">
                      All pages are visible in preview mode. Hidden pages will
                      show a red banner when disabled in production.
                    </p>
                  </div>
                )}
              </CardContent>
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    ...
                    <div className="flex items-center gap-2">
                      <Badge
                        variant={
                          getProductionFeatureState("ofacCheckEnabled")
                            ? "default"
                            : "destructive"
                        }
                        className="text-xs"
                  ...
                  {isLovablePreview && (
                    <div className="flex items-center justify-between bg-muted/50 p-2 rounded">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(enabled) =>
                          handleFeatureToggle("ofacCheckEnabled", enabled)
                        }
                      />
                    </div>
                  )}
