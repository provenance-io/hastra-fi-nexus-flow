                ...
                <div className="relative z-10 text-center">
                  ...
                  <div className="flex justify-center gap-12">
                    <a 
                      ...
                      className="group p-6 rounded-full border-2 border-mint-green/30 hover:border-mint-green/60 transition-all duration-300 hover:shadow-lg hover:shadow-mint-green/30"
                      style={{
                    ...
                    >
                      <svg 
                        className="w-10 h-10 text-mint-green group-hover:scale-110 transition-transform duration-300" 
                        fill="currentColor" 
                        viewBox="0 0 24 24"
                      >
                    ...
                    <a 
                      ...
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="group p-6 rounded-full border-2 border-electric-blue/30 hover:border-electric-blue/60 transition-all duration-300 hover:shadow-lg hover:shadow-electric-blue/30"
                      style={{
                    ...
                    >
                      <svg 
                        className="w-10 h-10 text-electric-blue group-hover:scale-110 transition-transform duration-300" 
                        fill="currentColor" 
                        viewBox="0 0 24 24"
                      >
