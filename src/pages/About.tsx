            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className={`card-gradient rounded-3xl p-8 md:p-12 card-bottom-static transition-all duration-500 ${
                ...
                <div className="relative z-10 text-center">
                  ...
                  {/* Social Media Icons with Hero Gradient */}
                  <div className="flex justify-center gap-12">
                    <a 
                      href="https://discord.gg/hastra" 
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="group p-6 rounded-full border-2 border-white/20 hover:border-white/40 transition-all duration-300 hover:shadow-lg hover:shadow-header-glow/30"
                      style={{
                        background: 'rgba(255, 255, 255, 0.05)',
                        backdropFilter: 'blur(16px)',
                        boxShadow: '0 0 20px rgba(229, 218, 194, 0.2)'
                      }}
                    >
                      <svg 
                        className="w-10 h-10 text-gradient group-hover:scale-110 transition-transform duration-300" 
                        fill="currentColor" 
                        viewBox="0 0 24 24"
                        style={{
