              ...
              <div className="card-gradient rounded-3xl p-8 md:p-12 card-bottom-static border border-transparent">
                <div className="space-y-8 text-foreground/90 leading-relaxed">
                  ...
                  <section>
                    ...
                    <p>
                      Holders of sYLDS may accrue yield over time, which is
                    ...
                    <ul className="list-disc pl-6 space-y-2">
                      ...
                      <li>Connect their wallet holding sYLDS;</li>
                      <li>
                  ...
                  <section>
                    ...
                    <p>
                      While Hastra facilitates the exchange of USDC for sYLDS
                  ...
                  <section>
                    ...
                    <ul className="list-disc pl-6 space-y-2">
                      ...
                      <li>
                        ...
                        distribution of sYLDS is entirely at your own risk;
                      </li>
                      <li>
                    ...
                    <p>
                      ...
                      participating in any distribution of sYLDS, you represent
