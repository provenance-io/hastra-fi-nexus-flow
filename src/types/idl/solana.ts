    ...
    "instructions": [
        {
            ...
            "docs": [
                ...
                "and receive an equal amount of minted tokens (e.g., YIELD) in return.",
                ...
                "",
                "```rust",
                "// Deposit 100 USDC and receive 100 YIELD",
            ...
            "accounts": [
                ...
                },
                {
                    "name": "vault",
                    "docs": [
                        "The vault account that receives the deposited tokens."
                    ],
                    "writable": true
                },
                {
                ...
                },
                {
                    "name": "config",
                    "docs": [
                        "The config account containing vault and mint addresses."
                    ],
                    "pda": {
                        "seeds": [
                            {
        ...
        },
        {
            ...
            "docs": [
                ...
                "* `mint_key` - The token address that will be minted to users (e.g., YIELD)",
                "",
                "# Errors",
                "",
                "Returns an error if:",
                ...
                "",
                "```rust",
                "// Initialize with USDC as vault and YIELD as mint",
            ...
            "accounts": [
                {
                    "name": "config",
                    "docs": [
                        "The config account containing the mint address."
                    ],
                    "pda": {
                        "seeds": [
                            {
                ...
                },
                {
                    "name": "mint",
                    "docs": [
                        "The mint account whose authority will be changed."
                    ],
                    "writable": true
                },
                {
                ...
                },
                {
                    "name": "mintAuthority",
                    "docs": [
                        "The PDA that currently serves as the mint authority."
                    ],
                    "writable": true,
                    "pda": {
                        "seeds": [
                ...
                },
                {
                    "name": "tokenProgram",
                    "docs": [
                        "The SPL Token program for authority changes."
                    ],
                    "address": "TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA"
                }
            ],
            ...
            "type": {
                ...
                "fields": [
                    ...
                    },
                    {
                        "name": "mint",
                        "docs": [
                            "The token address that will be minted to users (e.g., YIELD)."
                        ],
                        "type": "pubkey"
                    }
                ]
