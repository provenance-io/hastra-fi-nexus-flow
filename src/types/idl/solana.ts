  ...
  instructions: [
    {
      ...
      docs: [
        ...
        "and receive an equal amount of minted tokens (e.g., sPRIME) in return.",
        ...
        "",
        "```rust",
        "// Deposit 100 USDC and receive 100 sPRIME",
    ...
    },
    {
      ...
      docs: [
        ...
        "* `mint_key` - The token address that will be minted to users (e.g., sPRIME)",
        "",
        "# Errors",
        "",
        "Returns an error if:",
        ...
        "",
        "```rust",
        "// Initialize with USDC as vault and sPRIME as mint",
      ...
      type: {
        ...
        fields: [
          ...
          },
          {
            name: "mint",
            docs: [
              "The token address that will be minted to users (e.g., sPRIME).",
            ],
            type: "pubkey",
          },
        ],
