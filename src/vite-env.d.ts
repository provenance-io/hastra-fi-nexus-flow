...
interface ImportMetaEnv {
  ...
  VITE_SOLANA_PRIME_VAULT: string;
  VITE_SOLANA_PRIME_VAULT_TOKEN_ACCOUNT: string;
  VITE_SOLANA_PRIME_CONFIG_PDA: string;
  VITE_SOLANA_PRIME_MINT_AUTHORITY_PDA: string;
